...
let html="<table><tr><th>S.No</th><th>Name</th><th>Rank</th><th>Lvl</th><th>Number</th></tr>";
...
<tr>
<td class="memberName">${m.name}</td>
<td class="contribution">${formatMoney(m.money)}</td>
...
1️⃣ Leader absent hone par family handle karega<br>
2️⃣ War planning me leader ko support karega<br>
3️⃣ Members activity check karega<br>
4️⃣ New members ko rules samjhaye<br>
5️⃣ Internal issues leader ko report kare<br>
6️⃣ Power misuse allowed nahi
...
if(localStorage.getItem("user")) openDashboard();        2️⃣ 🚫 Zero Toxicity Policy<br>
        3️⃣ ⚔️ War Discipline<br>
        4️⃣ 🕒 Activity Requirement<br>
        5️⃣ ❌ No Internal Conflicts<br>
        6️⃣ 📘 Server Rules Compliance<br>
